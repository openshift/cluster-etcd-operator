...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RetentionCountConfig) DeepCopyInto(out *RetentionCountConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RetentionCountConfig.
func (in *RetentionCountConfig) DeepCopy() *RetentionCountConfig {
	if in == nil {
		return nil
	}
	out := new(RetentionCountConfig)
	in.DeepCopyInto(out)
	return out
}
