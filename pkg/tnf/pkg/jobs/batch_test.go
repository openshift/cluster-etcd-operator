...
func TestInferImagePullPolicy(t *testing.T) {
	tests := []struct {
		...
		{name: "digest", image: "busybox@sha256:abc123", expected: corev1.PullIfNotPresent},
		{name: "registry with digest", image: "gcr.io/my-project/image@sha256:abc123def456", expected: corev1.PullIfNotPresent},
	}
