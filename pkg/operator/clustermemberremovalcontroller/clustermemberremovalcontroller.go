...
func (c *clusterMemberRemovalController) sync(ctx context.Context, syncCtx factory.SyncContext) error {
	...
	bootstrapComplete, err := ceohelpers.IsBootstrapComplete(c.configMapLister, c.operatorClient, c.etcdClient, c.machineAPIChecker, c.masterMachineLister, c.masterMachineSelector, c.masterNodeLister, c.networkLister)
	if err != nil {
