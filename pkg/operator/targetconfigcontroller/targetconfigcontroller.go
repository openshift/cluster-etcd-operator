...
func (c *TargetConfigController) createTargetConfig(
	...
	podSub, err := c.getPodSubstitution(operatorSpec, c.targetImagePullSpec, c.operatorImagePullSpec, envVars, backupVar)
	if err != nil {
		return err
	}
...
func (c *TargetConfigController) getPodSubstitution(
	operatorSpec *operatorv1.StaticPodOperatorSpec,
	imagePullSpec, operatorImagePullSpec string,
	envVarMap map[string]string,
	backupVar backuphelpers.BackupVar) (*PodSubstitutionTemplate, error) {
