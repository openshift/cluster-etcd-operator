...
func getEtcdctlEnvVars(envVarContext envVarContext) (map[string]string, error) {
	...
	return map[string]string{
		...
		"ETCDCTL_CERT":      "/etc/kubernetes/static-pod-certs/secrets/etcd-all-peer/etcd-peer-NODE_UID.crt",
		"ETCDCTL_KEY":       "/etc/kubernetes/static-pod-certs/secrets/etcd-all-peer/etcd-peer-NODE_UID.key",
